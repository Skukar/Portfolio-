      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; halo nama gua
              Adit Zandika gua tinggal di bekasi
              ya mungkin ini pertama kali gua
              buat portfololio dan yap 
              ini bukan pure punya gua 
              ini gua dapet dari bang bagas rakha
              makasih buat bang bagas udah ngasih
              soure codenya dan yap ini gua mau 
              belajar ngoding namun gua sedang 
              mencari referensi dan sekailian 
              belajar otodidak ya walau ga bisa
